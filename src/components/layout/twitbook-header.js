    ...
    render() {
        ...
        <nav role="navigation">
            <div id="menuToggle">
                ...
                <ul id="menu">
                    <a @click=${this.closeMenuHandler} href="/">
                        <li>Actualités</li>
                    </a>
                    <a @click=${this.closeMenuHandler} href="/messages">
                        <li>Messages</li>
                    </a>
                    <a @click=${this.closeMenuHandler} href="/notifications">
                        <li>Notifications</li>
                    </a>
                    <a @click=${this.closeMenuHandler} href="/contact">
                        <li>Contact</li>
                    </a>
                </ul>
            </div>
